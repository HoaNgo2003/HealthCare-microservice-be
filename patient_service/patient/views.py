...
from .serializers import MedicalRecordSerializer, AppointmentSerializer, AppointmentCreateSerializer
from rest_framework.permissions import AllowAny
AUTH_SERVICE_USERINFO_URL = "http://127.0.0.1:8000/api/accounts/auth/profile/"
    ...
    def get_patient_info(self, request):
        ...
        try:
            ...
            if user_data.get('role') != 'patient':
                return None, Response({'detail': 'User is not a patient'}, status=status.HTTP_403_FORBIDDEN)

            return user_data, None

        except requests.RequestException as e:
            return None, Response({'detail': 'Error contacting AuthService', 'error': str(e)}, status=500)
